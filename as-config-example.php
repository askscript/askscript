...
*/
	...
	define('AS_MYSQL_HOSTNAME', '127.0.0.1'); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('AS_MYSQL_USERNAME', 'your-mysql-username');
	define('AS_MYSQL_PASSWORD', 'your-mysql-password');
	define('AS_MYSQL_DATABASE', 'your-mysql-db-name');
...
/*
	...
	Note than if multiple Q2A sites are using AS_MYSQL_USERS_PREFIX to share users, they must
...
/*
	If you wish, you can define AS_COOKIE_DOMAIN so that any cookies created by Q2A are assigned
...
/*
	If you wish, you can define an array $AS_CONST_PATH_MAP to modify the URLs used in your Q2A site.
...
/*
	...
	The constants AS_EXTERNAL_LANG and AS_EXTERNAL_EMAILER are deprecated from Q2A 1.5 since the same
...
/*
	...
	Set AS_PERSISTENT_CONN_DB to true to use persistent database connections. Only use this if
