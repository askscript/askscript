...
/*
	...
	File: as-include/as-app-events.php
...
*/
	...
	function as_create_event_for_q_user($questionid, $lastpostid, $updatetype, $lastuserid, $otheruserid=null, $timestamp=null)
/*
...
*/
	{
		as_db_event_create_for_entity(AS_ENTITY_QUESTION, $questionid, $questionid, $lastpostid, $updatetype, $lastuserid, $timestamp); // anyone who favorited the question

		if (isset($lastuserid) && !AS_FINAL_EXTERNAL_USERS)
			as_db_event_create_for_entity(AS_ENTITY_USER, $lastuserid, $questionid, $lastpostid, $updatetype, $lastuserid, $timestamp); // anyone who favorited the user who did it

		if (isset($otheruserid) && ($otheruserid!=$lastuserid))
			as_db_event_create_not_entity($otheruserid, $questionid, $lastpostid, $updatetype, $lastuserid, $timestamp); // possible other user to be informed
	}
	

	function as_create_event_for_tags($tagstring, $questionid, $updatetype, $lastuserid, $timestamp=null)
/*
...
*/
	{
		...
		foreach ($tagwordids as $wordid)
			as_db_event_create_for_entity(AS_ENTITY_TAG, $wordid, $questionid, $questionid, $updatetype, $lastuserid, $timestamp);
	}
	

	function as_create_event_for_category($categoryid, $questionid, $updatetype, $lastuserid, $timestamp=null)
/*
...
*/
	{
		if (isset($categoryid)) {
			...
			foreach ($categories as $category)
				as_db_event_create_for_entity(AS_ENTITY_CATEGORY, $category['categoryid'], $questionid, $questionid, $updatetype, $lastuserid, $timestamp);
		}
	}
