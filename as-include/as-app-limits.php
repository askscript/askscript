...
/*
	...
	File: as-include/as-app-limits.php
...
*/
	...
	define('AS_LIMIT_QUESTIONS', 'Q');
	define('AS_LIMIT_ANSWERS', 'A');
...
/*
	...
	where $action is one of the AS_LIMIT_* constants defined above.
*/
	{
...
/*
	...
	of the AS_LIMIT_* constants above. This function is no longer used and only included for backwards compatibility.
*/
	{
		if (as_to_override(__FUNCTION__)) { $args=func_get_args(); return as_call_override(__FUNCTION__, $args); }
		
		require_once AS_INCLUDE_DIR.'as-db-limits.php';
