...
/*
	...
	File: as-include/as-page-admin-stats.php
	...
	$as_content['form']=array(
		...
		'fields' => array(
			...
			'q2a_latest' => array(
				...
				'type' => 'custom',
				'html' => '<iframe src="http://www.question2answer.org/question2answer-latest.php?version='.urlencode(AS_VERSION).'&language='.urlencode(as_opt('site_language')).
			...
			'users' => array(
				...
				'value' => AS_FINAL_EXTERNAL_USERS ? '' : as_html(number_format(as_db_count_users())),
			),
