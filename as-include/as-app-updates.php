...
/*
	...
	File: as-include/as-app-updates.php
...
//	Character codes for the different types of updates on a post (updatetype columns)
	...
	define('AS_UPDATE_CATEGORY', 'A'); // questions only, category changed
	define('AS_UPDATE_CLOSED', 'C'); // questions only, closed or reopened
	...
	define('AS_UPDATE_TAGS', 'T'); // questions only
...
//	Character codes for types of update that only appear in the streams tables, not on the posts themselves
	...
	define('AS_UPDATE_FOLLOWS', 'F'); // if a new question was asked related to one of its answers, or for a comment that follows another
	define('AS_UPDATE_C_FOR_Q', 'U'); // if comment created was on a question of the user whose stream this appears in
	define('AS_UPDATE_C_FOR_A', 'N'); // if comment created was on an answer of the user whose stream this appears in
