...
/*
	...
	File: as-include/as-ajax-wallpost.php
...
*/
	...
	$errorhtml=as_wall_error_html($loginuserid, $touseraccount['userid'], $touseraccount['flags']);
	...
	if ($errorhtml || (!strlen($message)) || !as_check_form_security_code('wall-'.$tohandle, as_post_text('code')) )
		...
		$messageid=as_wall_add_post($loginuserid, as_get_logged_in_handle(), as_cookie_get(),
