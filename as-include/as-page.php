...
/*
	Run the appropriate as-page-*.php file for this request and return back the $as_content it passed 
*/
	{
		if (as_to_override(__FUNCTION__)) { $args=func_get_args(); return as_call_override(__FUNCTION__, $args); }
		...
		if (isset($routing[$requestlower])) {
			...
			$as_content=require AS_INCLUDE_DIR.'as-page-question.php';
	
		} else {
			as_set_template(strlen($firstlower) ? $firstlower : 'as'); // will be changed later
			$as_content=require AS_INCLUDE_DIR.'as-page-default.php'; // handles many other pages, including custom pages and page modules
		}
...
*/
	{
		...
		$as_content['script_rel']=array('as-content/jquery-1.7.2.min.js');
		$as_content['script_rel'][]='as-content/as-page.js?'.AS_VERSION;
