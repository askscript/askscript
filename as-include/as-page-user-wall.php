...
/*
	...
	File: as-include/as-page-user-wall.php
...
//	$handle, $userhtml are already set by as-page-user.php
...
//	Process deleting or adding a wall post (similar but not identical code to qq-page-user-profile.php)
	...
	if (as_clicked('dowallpost')) {
		...
		elseif (!$wallposterrorhtml) {
			as_wall_add_post($loginuserid, as_get_logged_in_handle(), as_cookie_get(), $useraccount['userid'], $useraccount['handle'], $inmessage, '');
