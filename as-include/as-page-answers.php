...
/*
	...
	File: as-include/as-page-answers.php
...
//	Get list of answers with related questions, plus category information
	...
	if ($countslugs) {
		...
		$nonetitle=as_lang_html_sub('main/no_answers_in_x', $categorytitlehtml);

	} else {
		$sometitle=as_lang_html('main/recent_as_title');
		$nonetitle=as_lang_html('main/no_answers_found');
	}
...
//	Prepare and return content for theme
	...
	return as_q_list_page_content(
		...
		as_opt('feed_for_activity') ? 'answers' : null, // prefix for RSS feed paths (null to hide)
