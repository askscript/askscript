...
//	Display the appropriate page based on the request	
	...
	switch (as_request_part(2)) {
		case 'wall':
			...
			$as_content=include QA_INCLUDE_DIR.'qa-page-user-wall.php';
			break;
		
		case 'activity':
			as_set_template('user-activity');
			$as_content=include QA_INCLUDE_DIR.'qa-page-user-activity.php';
			break;

		case 'questions':
			as_set_template('user-questions');
			$as_content=include QA_INCLUDE_DIR.'qa-page-user-questions.php';
			break;

		case 'answers':
			as_set_template('user-answers');
			$as_content=include QA_INCLUDE_DIR.'qa-page-user-answers.php';
			break;

		case null:
			$as_content=include QA_INCLUDE_DIR.'qa-page-user-profile.php';
			break;
			
		default:
			$as_content=include QA_INCLUDE_DIR.'qa-page-not-found.php';
			break;
	}
