...
*/
	{
		...
		if (
			...
			$permiterror=as_user_post_permit_error(($post['basetype']=='Q') ? 'permit_vote_q' : 'permit_vote_a', $post, QA_LIMIT_VOTES);
...
*/
	{
		...
		if (
			...
			switch (as_user_post_permit_error('permit_flag', $post, QA_LIMIT_FLAGS)) {
				case 'login':
