...
//	Prepare content for theme
	...
	if ($setmissing) {
		...
		if ($setparent) {
			...
			@$as_content['form']['fields']['parent']['note'].=as_lang_html_sub('admin/category_max_depth_x', QA_CATEGORY_DEPTH);
		...
		if (!$setparent) {
			...
			if (isset($editcategory['categoryid'])) {
				...
				if ($catdepth<QA_CATEGORY_DEPTH) {
					...
					$as_content['form']['fields']['name']['note']=as_lang_html_sub('admin/category_no_add_subs_x', QA_CATEGORY_DEPTH);
				}
