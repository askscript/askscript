...
*/
	{
		...
		return as_path('blob', array('as_blobid' => $blobid), $absolute ? as_opt('site_url') : null, QA_URL_FORMAT_PARAMS);
	}
...
*/
	{
		...
		$blobid=as_db_blob_create(defined('QA_BLOBS_DIRECTORY') ? null : $content, $format, $sourcefilename, $userid, $cookieid, $ip);
