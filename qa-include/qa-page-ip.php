...
*/
	...
	$ip=as_request_part(1); // picked up from qa-page.php
...
//	Check we have permission to view this page, and whether we can block or unblock IPs
	...
	$blockable=as_user_level_maximum()>=QA_USER_LEVEL_MODERATOR; // allow moderator in one category to block across all categories
